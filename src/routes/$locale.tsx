...
import RhinePortal from "@/components/portal/RhinePortal";
...
function LocaleLandingPage() {
  ...
  // The 3D Rhine Lab terminal replaced the old marketing landing page.
  // Legacy components stay in src/components/home for possible rollback.
  return <RhinePortal />;
}
